...
export default function Item({ icon: Icon, label, onClick, active, documentIcon, expanded, id, isSearch, level = 0, onExpand }: ItemProps) {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className='w-60' align='start' side='right' forceMount>
              <DropdownMenuItem onClick={onArchive}>
                <Trash className='h-4 w-4 mr-2' />В корзину
              </DropdownMenuItem>
