  ...
  return (
    <div className='text-sm'>
      <div className='flex items-center gap-x-1 p-2'>
        ...
        <Input value={search} onChange={(e) => setSearch(e.target.value)} className='h-7 px-2 focus-visible:ring-transparent bg-secondary' placeholder='По названию...' />
      </div>
      <div className='mt-2 px-1 pb-1'>
        <p className='hidden last:block text-xs text-center text-muted-foreground pb-2'>Заметок не найдено.</p>
